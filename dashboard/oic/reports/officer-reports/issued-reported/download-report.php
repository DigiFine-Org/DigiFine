...
// Fetch data for the fines by reported status table
$url = "http://localhost/digifine/dashboard/oic/reports/officer-reports/issued-reported/get-fines.php?police_id=" . urlencode($policeId) . "&time_period=" . urlencode($timePeriod);
...
// Generate fines by reported status table rows
$tableRows = '';
$dates = [];
...
// Download PDF
$dompdf->stream("fines_by_reported_status_" . date('Ymd_His') . ".pdf", ["Attachment" => 1]);
exit;
