...
$url = "http://localhost/digifine/dashboard/oic/reports/officer-reports/issued-place/get-fines.php?police_id=" . urlencode($policeId) . "&time_period=" . urlencode($timePeriod);
