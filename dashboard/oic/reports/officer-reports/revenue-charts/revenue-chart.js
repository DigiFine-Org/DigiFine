window.fetchRevenueData = function () {
  const officerId = document.getElementById("officerId").value;
  const timePeriod = document.getElementById("timePeriod").value;

  fetch(
    `revenue-charts/get-fines.php?police_id=${officerId}&time_period=${timePeriod}`
  )
    ...
    .then((data) => {
      ...
      if (data.error) {
        ...
        updateRevenueChart(data, timePeriod);
        updateRevenueSummary(data, timePeriod); // Assuming this updates summary stats
