...
// Fetch data for the offences table
$url = "http://localhost/digifine/dashboard/oic/reports/offence/get-offences.php?police_station=" . urlencode($policeStationId) . "&time_period=" . urlencode($timePeriod);
...
// Download PDF
$dompdf->stream("offences_report_" . date('Ymd_His') . ".pdf", ["Attachment" => 1]);
exit;
