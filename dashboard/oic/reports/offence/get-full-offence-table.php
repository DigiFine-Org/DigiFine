...
$url = "http://localhost/digifine/dashboard/oic/reports/offence/get-offences.php?police_station=$policeStationId&time_period=$timePeriod";
        ...
        <div class="content">
            ...
            <div class="table-container">
                <div class="buttons" style="margin-bottom: 20px;">
                    <a href="download-full-offence.php?time_period=<?= urlencode($timePeriod) ?>&download=true" class="btn">
