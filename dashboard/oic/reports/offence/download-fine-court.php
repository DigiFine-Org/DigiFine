...
// Fetch data for the fines and court cases table
$url = "http://localhost/digifine/dashboard/oic/reports/offence/get-fine-court.php?police_station=" . urlencode($policeStationId) . "&time_period=" . urlencode($timePeriod);
...
// Generate fines and court cases table rows
$tableRows = '';
$dates = [];
...
// Download PDF
$dompdf->stream("fines_and_court_cases_report_" . date('Ymd_His') . ".pdf", ["Attachment" => 1]);
exit;
