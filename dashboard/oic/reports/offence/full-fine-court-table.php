...
$url = "http://localhost/digifine/dashboard/oic/reports/offence/get-fine-court.php?police_station=$policeStationId&time_period=$timePeriod";
...
<main>
    ...
    <div class="dashboard-layout">
        ...
        <div class="content">
            ...
            <h2>Full Report of Fines by Fine-Court Status - <?= htmlspecialchars($timePeriod) ?></h2>
            <div class="table-container">
                <div class="buttons" style="margin-bottom: 20px;">
                    <a href="download-fine-court.php?time_period=<?= urlencode($timePeriod) ?>&download=true" class="btn">
