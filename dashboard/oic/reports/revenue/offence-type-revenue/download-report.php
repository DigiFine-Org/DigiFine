...
$url = "http://localhost/digifine/dashboard/oic/reports/revenue/offence-type-revenue/get-offences-revenue.php?police_station=" . urlencode($policeStationId) . "&time_period=" . urlencode($timePeriod);
