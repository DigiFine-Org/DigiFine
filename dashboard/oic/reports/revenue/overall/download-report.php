...
$url = "http://localhost/digifine/dashboard/oic/reports/revenue/overall/get-fines.php?police_station=" . urlencode($policeStationId) . "&time_period=" . urlencode($timePeriod);
