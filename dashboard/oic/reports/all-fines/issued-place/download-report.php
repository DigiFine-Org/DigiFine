...
$url = "http://localhost/digifine/dashboard/oic/reports/all-fines/issued-place/get-fines.php?time_period=" . urlencode($timePeriod) . "&police_station=" . urlencode($policeStationId);
