                ...
                <form action="edit-offence-process.php" method="post">
                    <div class="field">
                        ...
                        <input type="text" class="input" placeholder="001" name="offence_number"
                            value="<?= htmlspecialchars($offence['offence_number']) ?>" readonly required>
                    </div>
                    <div class="field">
                        ...
                        <input type="text" class="input" placeholder="හඳුනාගැනීමේ තහඩු" name="description_sinhala"
                            value="<?= htmlspecialchars($offence['description_sinhala']) ?>" required>
                    </div>
                    <div class="field">
                        ...
                        <input type="text" class="input" placeholder="அடையாளங்காணல் தகடுகள்" name="description_tamil"
                            value="<?= htmlspecialchars($offence['description_tamil']) ?>" required>
                    </div>
                    <div class="field">
