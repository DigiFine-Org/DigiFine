...
$url = "http://localhost/digifine/dashboard/admin/reports/offence/get-offences.php?time_period=" . urlencode($timePeriod);
        ...
        <div class="content">
            ...
            <div class="table-container">
                <div class="buttons" style="margin-bottom: 20px;">
                    <a href="download-offence-report.php?time_period=<?= urlencode($timePeriod) ?>&download=true" class="btn">
