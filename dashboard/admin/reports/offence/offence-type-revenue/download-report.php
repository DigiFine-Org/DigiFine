...
// Fetch data from the same source used by full-offence-revenue-table.php
$url = "http://localhost/digifine/dashboard/admin/reports/offence/offence-type-revenue/get-offences-revenue.php?time_period=" . urlencode($timePeriod);
...
// Download PDF
$dompdf->stream("full_report_offence_type_" . date('Ymd_His') . ".pdf", ["Attachment" => 1]);
exit;
