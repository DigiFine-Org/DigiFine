...
$url = "http://localhost/digifine/dashboard/admin/reports/officer-reports/revenue-charts/get-fines.php?police_id=" . urlencode($policeId) . "&time_period=" . urlencode($timePeriod);
