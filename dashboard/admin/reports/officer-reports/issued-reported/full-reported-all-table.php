...
$url = "http://localhost/digifine/dashboard/admin/reports/officer-reports/issued-reported/get-fines.php?police_id=" . urlencode($policeId) . "&time_period=" . urlencode($timePeriod);
...
<main>
    ...
    <div class="dashboard-layout">
        ...
        <div class="content">
            ...
            <h2>Full Report of Fines by Reported Status - <?= htmlspecialchars($timePeriod) ?> of Officer <?= htmlspecialchars($policeId) ?></h2>
