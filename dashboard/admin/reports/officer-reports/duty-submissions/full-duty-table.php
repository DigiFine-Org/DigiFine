...
$url = "http://localhost/digifine/dashboard/admin/reports/officer-reports/duty-submissions/get-duty.php?police_id=" . urlencode($policeId) . "&time_period=" . urlencode($timePeriod);
        ...
        <div class="content">
            ...
            <div class="table-container">
                <div class="buttons" style="margin-bottom: 20px;">
                    <a href="download-report.php?time_period=<?= urlencode($timePeriod) ?>&officer_id=<?= urlencode($policeId) ?>&download=true" class="btn">
