...
// Fetch data from the same source used by full-duty-table.php
...
<div class="container">
    <div class="header">
        <div class="title">Full Report of Duty Submissions by Officer ' . htmlspecialchars($policeId) . '</div>
    </div>
...
// Download PDF
$dompdf->stream("duty_report_" . date('Ymd_His') . ".pdf", ["Attachment" => 1]);
exit;
