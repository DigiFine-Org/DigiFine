...
function fetchFinesByStatus($conn, $interval, $group_by, $fine_status)
{
...
$paidFines = fetchFinesByStatus($conn, $interval, $group_by, 'paid');
$pendingFines = fetchFinesByStatus($conn, $interval, $group_by, 'pending');
$overdueFines = fetchFinesByStatus($conn, $interval, $group_by, 'overdue');
