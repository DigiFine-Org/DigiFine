...
// Fetch data from the same source used by full-issued-police-station-table.php
...
<div class="container">
    <div class="header">
        <div class="title">Full Report of Fines by Issued Police Station</div>
    </div>
...
// Download PDF
$dompdf->stream("full_report_issued_police_stations_" . date('Ymd_His') . ".pdf", ["Attachment" => 1]);
exit;
