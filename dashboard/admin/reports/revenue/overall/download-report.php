...
$url = "http://localhost/digifine/dashboard/admin/reports/revenue/overall/get-fines.php?time_period=" . urlencode($timePeriod);
...
<div class="container">
    <div class="header">
        <div class="title">Full Report of Revenue</div>
    </div>
