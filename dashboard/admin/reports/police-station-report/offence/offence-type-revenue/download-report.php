...
$url = "http://localhost/digifine/dashboard/admin/reports/police-station-report/offence/offence-type-revenue/get-offences-revenue.php?police_station=" . urlencode($policeStationId) . "&time_period=" . urlencode($timePeriod);
