...
$url = "http://localhost/digifine/dashboard/admin/reports/police-station-report/offence/get-fine-court.php?police_station=" . urlencode($policeStationId) . "&time_period=" . urlencode($timePeriod);
