...
$url = "http://localhost/digifine/dashboard/admin/reports/police-station-report/offence/get-fine-court.php?police_station=$policeStationId&time_period=$timePeriod";
        ...
        <div class="content">
            ...
            <div class="table-container">
                <div class="buttons" style="margin-bottom: 20px;">
                    <a href="download-fine-court-report.php?time_period=<?= urlencode($timePeriod) ?>&station_id=<?= htmlspecialchars($policeStationId) ?>&download=true" class="btn">
