...
$url = "http://localhost/digifine/dashboard/admin/reports/revenue/overall/get-fines.php?police_station=" . urlencode($policeStationId) . "&time_period=" . urlencode($timePeriod);
