...
// Fetch data for the fines by issued place table
$url = "http://localhost/digifine/dashboard/admin/reports/police-station-report/revenue/issued-place/location-get-fines.php?police_station=" . urlencode($policeStationId) . "&time_period=" . urlencode($timePeriod);
...
// Generate fines by issued place table rows
$tableRows = '';
if (!empty($data)) {
    $rank = 1;
    foreach ($data as $row) {
