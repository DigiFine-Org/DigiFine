...
$url = "http://localhost/digifine/dashboard/admin/reports/police-station-report/officer-reports/duty-submissions/get-duty.php?police_id=" . urlencode($policeId) . "&time_period=" . urlencode($timePeriod);
...
<main>
    ...
    <div class="dashboard-layout">
        ...
        <div class="content">
            ...
            <h2>Full Report of Duty Submissions by Officer <?= htmlspecialchars($policeId) ?> - <?= htmlspecialchars($timePeriod) ?></h2>

            <div class="table-container">
                <div class="buttons" style="margin-bottom: 20px;">
                    <a href="download-report.php?time_period=<?= urlencode($timePeriod) ?>&officer_id=<?= htmlspecialchars($policeId) ?>&download=true" class="btn">
            ...
            <div class="table-container">
                <table>
                    <thead>
                        <tr>
                            <th>Date</th>
                            <th>All Submisions</th>
                            <th>On Time submission</th>
                            <th>Late Submisions</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
