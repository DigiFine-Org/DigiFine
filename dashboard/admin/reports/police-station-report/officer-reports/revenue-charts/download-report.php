...
// Fetch data from the same source used by get-full-revenue-report.php
$url = "http://localhost/digifine/dashboard/admin/reports/police-station-report/officer-reports/revenue-charts/get-fines.php?police_id=" . urlencode($policeId) . "&time_period=" . urlencode($timePeriod);
...
<div class="container">
    <div class="header">
        <div class="title">Full Report of Revenue by Officer</div>
    </div>
